            ...
            <div class="col-lg-6 col-md-12">
                <div class="container">
                    <div class="row text-center tasktypea">
                        <div class="col-5  mx-2"><a href="EmployeeTask.php">Task</a></div>
                        <div class="col-5 tasktype"><a href="EmployeeTask2.php">Project</a></div>
                    </div>
                    <div class="row">
                        <div class="board">
                        <form method="post">
                                <label class="form-label">Task Title</label>
                                <input type="text" class="form-control" placeholder="Title" name="projtitle">
                                <label class="form-label"><br>Description</label>
                                <textarea class="form-control" rows="8" placeholder="..." name="projdes"></textarea><br>
                                <div class="container">
                                    <div class="row">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-auto">Due Date: <input type="date" name="due"></div>
                            ...
                            <?php
                                if(isset($_POST["assign"])){
                                        ...
                                        $pcount = mysqli_query($conn , "SELECT MAX(Project_ID) FROM project");
                                        $pgetcount = mysqli_fetch_assoc($pcount);

                                        $projtitle = $_POST["projtitle"];
                                        $projdes = $_POST["projdes"];
                                        $projid = $pgetcount['MAX(Project_ID)'] + 1 ;
                                            ...
                                            try {
                                                ...
                                                foreach ($_POST as $key => $value) {
                                                    if (strpos($key, 'id-') !== false) {
                                                        ...
                                                        $sql = "INSERT INTO task (Task_ID, Task_Title, Task_Description, Status, Type, Start, Due, Employee_ID, Project_ID) VALUES ('$taskid', '$projtitle', '$projdes', 'Pending', 'Project', '$start', '$due', '$id', '$projid')";
                                    ...
                                    mysqli_query($conn , "INSERT INTO project (Project_ID,Project_Title,Project_Description,Number_of_Employee,Finished,Due) VALUES ('$projid','$projtitle','$projdes','$num','','$due')");
